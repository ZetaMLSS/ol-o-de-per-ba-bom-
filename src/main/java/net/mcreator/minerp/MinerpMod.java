...
@Mod("minerp")
public class MinerpMod {
	public static final Logger LOGGER = LogManager.getLogger(MinerpMod.class);
	public static final String MODID = "minerp";

	public MinerpMod(IEventBus modEventBus) {
