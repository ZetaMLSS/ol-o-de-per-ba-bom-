...
public class MinerpModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<ConfigurarSenhaComputadorBancarioMenu>> CONFIGURAR_SENHA_COMPUTADOR_BANCARIO = REGISTRY.register("configurar_senha_computador_bancario",
			() -> IMenuTypeExtension.create(ConfigurarSenhaComputadorBancarioMenu::new));
	public static final DeferredHolder<MenuType<?>, MenuType<InsiraSuaSenhaComputadorBanqueiroMenu>> INSIRA_SUA_SENHA_COMPUTADOR_BANQUEIRO = REGISTRY.register("insira_sua_senha_computador_banqueiro",
			() -> IMenuTypeExtension.create(InsiraSuaSenhaComputadorBanqueiroMenu::new));
	public static final DeferredHolder<MenuType<?>, MenuType<TelaDePesquisaComputadorBancoMenu>> TELA_DE_PESQUISA_COMPUTADOR_BANCO = REGISTRY.register("tela_de_pesquisa_computador_banco",
			() -> IMenuTypeExtension.create(TelaDePesquisaComputadorBancoMenu::new));
	...
	public static final DeferredHolder<MenuType<?>, MenuType<TelaCelularTelefoneMenu>> TELA_CELULAR_TELEFONE = REGISTRY.register("tela_celular_telefone", () -> IMenuTypeExtension.create(TelaCelularTelefoneMenu::new));
	public static final DeferredHolder<MenuType<?>, MenuType<TelaAdicionarContatoMenu>> TELA_ADICIONAR_CONTATO = REGISTRY.register("tela_adicionar_contato", () -> IMenuTypeExtension.create(TelaAdicionarContatoMenu::new));
