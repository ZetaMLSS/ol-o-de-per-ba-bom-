...
public class MinerpModItems {
	...
	public static final DeferredItem<Item> IMPRESSORA_DINHEIRO_FALSO;
	static {
		...
		IMPRESSORA_DINHEIRO_FALSO = block(MinerpModBlocks.IMPRESSORA_DINHEIRO_FALSO, new Item.Properties().stacksTo(1));
	}
