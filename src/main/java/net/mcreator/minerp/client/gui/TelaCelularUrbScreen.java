	...
	public void init() {
		...
		enhanced_image_button_invisivel_copy = new net.minecraft.client.gui.components.ImageButton(this.leftPos + 1, this.topPos + 86, 20, 18,
				...
				e -> {
					...
					int y = TelaCelularUrbScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.minerp.network.TelaCelularUrbButtonMessage(1, x, y, z));
						net.mcreator.minerp.network.TelaCelularUrbButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
