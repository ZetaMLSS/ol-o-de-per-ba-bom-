...
import net.mcreator.minerp.world.inventory.TelaCelularCriptoPortifolioMenu;
import net.mcreator.minerp.procedures.BateriaVisorProcedure;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaCelularCriptoPortifolioScreen extends AbstractContainerScreen<TelaCelularCriptoPortifolioMenu> implements MinerpModScreens.ScreenAccessor {
	private final Level world;
	private final int x, y, z;
	private final Player entity;
	private boolean menuStateUpdateActive = false;

	public TelaCelularCriptoPortifolioScreen(TelaCelularCriptoPortifolioMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_celular_cripto_portifolio.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiTools$orderedImages : {
			if (this.enhanced_image_button_invisivel_copy_copy_copy != null && this.enhanced_image_button_invisivel_copy_copy_copy.visible) {
				this.enhanced_image_button_invisivel_copy_copy_copy.render(guiGraphics, mouseX, mouseY, partialTicks);
			}
			if (true) {
	...
	public void init() {
		super.init();
		enhanced_image_button_invisivel_copy_copy_copy = new net.minecraft.client.gui.components.ImageButton(this.leftPos + 1, this.topPos + 86, 20, 18,
				...
				e -> {
					...
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.minerp.network.TelaCelularCriptoPortifolioButtonMessage(0, x, y, z));
						net.mcreator.minerp.network.TelaCelularCriptoPortifolioButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
			@Override
		...
		this.addWidget(enhanced_image_button_invisivel_copy_copy_copy);
		enhanced_image_button_invisivel = new net.minecraft.client.gui.components.ImageButton(this.leftPos + -23, this.topPos + -64, 32, 16,
				new net.minecraft.client.gui.components.WidgetSprites(net.minecraft.resources.ResourceLocation.parse("minerp:textures/screens/invisivel.png"), net.minecraft.resources.ResourceLocation.parse("minerp:textures/screens/invisivel.png")),
				e -> {
					int x = TelaCelularCriptoPortifolioScreen.this.x;
					int y = TelaCelularCriptoPortifolioScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.minerp.network.TelaCelularCriptoPortifolioButtonMessage(1, x, y, z));
						net.mcreator.minerp.network.TelaCelularCriptoPortifolioButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(net.minecraft.client.gui.GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		enhanced_image_button_invisivel_copy_copy = new net.minecraft.client.gui.components.ImageButton(this.leftPos + 2, this.topPos + 88, 20, 18,
				new net.minecraft.client.gui.components.WidgetSprites(net.minecraft.resources.ResourceLocation.parse("minerp:textures/screens/invisivel.png"), net.minecraft.resources.ResourceLocation.parse("minerp:textures/screens/invisivel.png")),
				e -> {
					int x = TelaCelularCriptoPortifolioScreen.this.x;
					int y = TelaCelularCriptoPortifolioScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.minerp.network.TelaCelularCriptoPortifolioButtonMessage(2, x, y, z));
						net.mcreator.minerp.network.TelaCelularCriptoPortifolioButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(net.minecraft.client.gui.GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
