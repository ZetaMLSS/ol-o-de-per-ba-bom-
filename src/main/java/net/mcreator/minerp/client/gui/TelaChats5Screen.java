...
import net.mcreator.minerp.world.inventory.TelaChats5Menu;
import net.mcreator.minerp.procedures.BateriaVisorProcedure;
import net.mcreator.minerp.network.TelaChats5ButtonMessage;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaChats5Screen extends AbstractContainerScreen<TelaChats5Menu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaChats5Screen(TelaChats5Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_chats_5.png");
	...
	public void init() {
		super.init();
		escrevermensagem = new EditBox(this.font, this.leftPos + -28, this.topPos + 30, 78, 18, Component.translatable("gui.minerp.tela_chats_5.escrevermensagem"));
		...
		button_enviar = Button.builder(Component.translatable("gui.minerp.tela_chats_5.button_enviar"), e -> {
			int x = TelaChats5Screen.this.x;
			int y = TelaChats5Screen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new TelaChats5ButtonMessage(0, x, y, z));
				TelaChats5ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
