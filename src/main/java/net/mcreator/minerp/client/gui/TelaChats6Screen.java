...
import net.mcreator.minerp.world.inventory.TelaChats6Menu;
import net.mcreator.minerp.procedures.BateriaVisorProcedure;
import net.mcreator.minerp.network.TelaChats6ButtonMessage;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaChats6Screen extends AbstractContainerScreen<TelaChats6Menu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaChats6Screen(TelaChats6Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_chats_6.png");
	...
	public void init() {
		super.init();
		escrevermensagem = new EditBox(this.font, this.leftPos + -28, this.topPos + 30, 78, 18, Component.translatable("gui.minerp.tela_chats_6.escrevermensagem"));
		...
		button_enviar = Button.builder(Component.translatable("gui.minerp.tela_chats_6.button_enviar"), e -> {
			int x = TelaChats6Screen.this.x;
			int y = TelaChats6Screen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new TelaChats6ButtonMessage(0, x, y, z));
				TelaChats6ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
