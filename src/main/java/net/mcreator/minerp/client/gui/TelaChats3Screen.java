...
import net.mcreator.minerp.world.inventory.TelaChats3Menu;
import net.mcreator.minerp.procedures.BateriaVisorProcedure;
import net.mcreator.minerp.network.TelaChats3ButtonMessage;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaChats3Screen extends AbstractContainerScreen<TelaChats3Menu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaChats3Screen(TelaChats3Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_chats_3.png");
	...
	public void init() {
		super.init();
		escrevermensagem = new EditBox(this.font, this.leftPos + -28, this.topPos + 30, 78, 18, Component.translatable("gui.minerp.tela_chats_3.escrevermensagem"));
		...
		button_enviar = Button.builder(Component.translatable("gui.minerp.tela_chats_3.button_enviar"), e -> {
			int x = TelaChats3Screen.this.x;
			int y = TelaChats3Screen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new TelaChats3ButtonMessage(0, x, y, z));
				TelaChats3ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
