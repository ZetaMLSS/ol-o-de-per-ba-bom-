...
import net.mcreator.minerp.world.inventory.TelaChats10Menu;
import net.mcreator.minerp.procedures.BateriaVisorProcedure;
import net.mcreator.minerp.network.TelaChats10ButtonMessage;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaChats10Screen extends AbstractContainerScreen<TelaChats10Menu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaChats10Screen(TelaChats10Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_chats_10.png");
	...
	public void init() {
		super.init();
		escrevermensagem = new EditBox(this.font, this.leftPos + -28, this.topPos + 30, 78, 18, Component.translatable("gui.minerp.tela_chats_10.escrevermensagem"));
		...
		button_enviar = Button.builder(Component.translatable("gui.minerp.tela_chats_10.button_enviar"), e -> {
			int x = TelaChats10Screen.this.x;
			int y = TelaChats10Screen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new TelaChats10ButtonMessage(0, x, y, z));
				TelaChats10ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
