...
import net.mcreator.minerp.world.inventory.TelaChats8Menu;
import net.mcreator.minerp.procedures.BateriaVisorProcedure;
import net.mcreator.minerp.network.TelaChats8ButtonMessage;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaChats8Screen extends AbstractContainerScreen<TelaChats8Menu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaChats8Screen(TelaChats8Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_chats_8.png");
	...
	public void init() {
		super.init();
		escrevermensagem = new EditBox(this.font, this.leftPos + -28, this.topPos + 30, 78, 18, Component.translatable("gui.minerp.tela_chats_8.escrevermensagem"));
		...
		button_enviar = Button.builder(Component.translatable("gui.minerp.tela_chats_8.button_enviar"), e -> {
			int x = TelaChats8Screen.this.x;
			int y = TelaChats8Screen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new TelaChats8ButtonMessage(0, x, y, z));
				TelaChats8ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
