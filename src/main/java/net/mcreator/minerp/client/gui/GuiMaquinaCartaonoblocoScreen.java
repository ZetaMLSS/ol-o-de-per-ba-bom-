...
public class GuiMaquinaCartaonoblocoScreen extends AbstractContainerScreen<GuiMaquinaCartaonoblocoMenu> implements MinerpModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		{
			guiGraphics.drawString(this.font, Component.translatable("gui.minerp.gui_maquina_cartaonobloco.label_dinheiro"), 93, 8, -12829636, false);
		}
		{
			guiGraphics.drawString(this.font, Component.translatable("gui.minerp.gui_maquina_cartaonobloco.label_ecreditooudebido"), 101, 24, -12829636, false);
		}
