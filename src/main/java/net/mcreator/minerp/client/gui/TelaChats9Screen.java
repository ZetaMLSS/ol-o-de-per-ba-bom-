...
import net.mcreator.minerp.world.inventory.TelaChats9Menu;
import net.mcreator.minerp.procedures.BateriaVisorProcedure;
import net.mcreator.minerp.network.TelaChats9ButtonMessage;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaChats9Screen extends AbstractContainerScreen<TelaChats9Menu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaChats9Screen(TelaChats9Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_chats_9.png");
	...
	public void init() {
		super.init();
		escrevermensagem = new EditBox(this.font, this.leftPos + -28, this.topPos + 30, 78, 18, Component.translatable("gui.minerp.tela_chats_9.escrevermensagem"));
		...
		button_enviar = Button.builder(Component.translatable("gui.minerp.tela_chats_9.button_enviar"), e -> {
			int x = TelaChats9Screen.this.x;
			int y = TelaChats9Screen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new TelaChats9ButtonMessage(0, x, y, z));
				TelaChats9ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
