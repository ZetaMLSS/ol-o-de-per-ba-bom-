...
import net.mcreator.minerp.network.TelaChatsNOTIFICACAOButtonMessage;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaChatsNOTIFICACAOScreen extends AbstractContainerScreen<TelaChatsNOTIFICACAOMenu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaChatsNOTIFICACAOScreen(TelaChatsNOTIFICACAOMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_chats_notificacao.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		this.guiTools$renderMultilineLabel(guiGraphics, java.util.Objects.toString(net.mcreator.minerp.procedures.NumeronotificacaoProcedure.execute(entity), ""), -28, -58, 79, 24, -12829636, false, 0.50F);
		this.guiTools$renderMultilineLabel(guiGraphics, java.util.Objects.toString(net.mcreator.minerp.procedures.MensagemnotificacaoProcedure.execute(entity), ""), -28, -29, 79, 24, -12829636, false, 0.50F);
		this.guiTools$renderMultilineLabel(guiGraphics, java.util.Objects.toString(net.mcreator.minerp.procedures.NumeronotificacaoProcedure.execute(entity), ""), -26, -86, 120, 40, -12829636, false, 1.00F);
	}

	@Override
	public void init() {
		super.init();
		button_enviar = Button.builder(Component.translatable("gui.minerp.tela_chats_notificacao.button_enviar"), e -> {
			int x = TelaChatsNOTIFICACAOScreen.this.x;
			int y = TelaChatsNOTIFICACAOScreen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new TelaChatsNOTIFICACAOButtonMessage(0, x, y, z));
				TelaChatsNOTIFICACAOButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
		}).bounds(this.leftPos + -19, this.topPos + 34, 62, 20).build();
