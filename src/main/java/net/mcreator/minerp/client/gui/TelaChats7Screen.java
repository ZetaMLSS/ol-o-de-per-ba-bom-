...
import net.mcreator.minerp.world.inventory.TelaChats7Menu;
import net.mcreator.minerp.procedures.BateriaVisorProcedure;
import net.mcreator.minerp.network.TelaChats7ButtonMessage;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaChats7Screen extends AbstractContainerScreen<TelaChats7Menu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaChats7Screen(TelaChats7Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_chats_7.png");
	...
	public void init() {
		super.init();
		escrevermensagem = new EditBox(this.font, this.leftPos + -28, this.topPos + 30, 78, 18, Component.translatable("gui.minerp.tela_chats_7.escrevermensagem"));
		...
		button_enviar = Button.builder(Component.translatable("gui.minerp.tela_chats_7.button_enviar"), e -> {
			int x = TelaChats7Screen.this.x;
			int y = TelaChats7Screen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new TelaChats7ButtonMessage(0, x, y, z));
				TelaChats7ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
