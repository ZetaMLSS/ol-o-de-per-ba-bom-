...
public class TelaCelularParamedicoScreen extends AbstractContainerScreen<TelaCelularParamedicoMenu> implements MinerpModScreens.ScreenAccessor {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		this.guiTools$renderMultilineLabel(guiGraphics, "Voc\u00EA deseja chamar os Param\u00E9dicos?", -29, -70, 80, 50, -3407872, false, 1.00F);
		this.guiTools$renderMultilineLabel(guiGraphics, "Lembre-se que chamadas falsas s\u00E3o crimes.", -28, -29, 80, 40, -12829636, false, 0.75F);
	}
