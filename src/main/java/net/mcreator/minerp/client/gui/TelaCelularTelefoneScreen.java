...
public class TelaCelularTelefoneScreen extends AbstractContainerScreen<TelaCelularTelefoneMenu> implements MinerpModScreens.ScreenAccessor {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		net.spidrone.uiapi.UIProgressBarRenderer.drawProgressBar(guiGraphics, this.leftPos + 24, this.topPos + -95, 16, 7, 1, -16777216, -14145496, net.spidrone.uiapi.UIColorEffects.multiGradient(-6750208, -256, -16724992, -16738048),
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		this.guiTools$renderMultilineLabel(guiGraphics, "Lista de Contatos", -26, -81, 84, 50, -13421773, false, 1.25F);
	}
	...
	public void init() {
		...
		}).bounds(this.leftPos + -27, this.topPos + 13, 55, 20).build();
		this.addRenderableWidget(button_chamar);
		Contatos = new ExtendedSlider(this.leftPos + -27, this.topPos + -50, 76, 20, Component.translatable("gui.minerp.tela_celular_telefone.Contatos_prefix"), Component.translatable("gui.minerp.tela_celular_telefone.Contatos_suffix"), 0, 10, 5, 1,
				0, true) {
			@Override
