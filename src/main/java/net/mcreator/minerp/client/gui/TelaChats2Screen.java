...
import net.mcreator.minerp.world.inventory.TelaChats2Menu;
import net.mcreator.minerp.procedures.BateriaVisorProcedure;
import net.mcreator.minerp.network.TelaChats2ButtonMessage;
import net.mcreator.minerp.init.MinerpModScreens;

import com.mojang.blaze3d.systems.RenderSystem;

public class TelaChats2Screen extends AbstractContainerScreen<TelaChats2Menu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaChats2Screen(TelaChats2Menu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_chats_2.png");
	...
	public void init() {
		super.init();
		escrevermensagem = new EditBox(this.font, this.leftPos + -28, this.topPos + 30, 78, 18, Component.translatable("gui.minerp.tela_chats_2.escrevermensagem"));
		...
		button_enviar = Button.builder(Component.translatable("gui.minerp.tela_chats_2.button_enviar"), e -> {
			int x = TelaChats2Screen.this.x;
			int y = TelaChats2Screen.this.y;
			if (true) {
				PacketDistributor.sendToServer(new TelaChats2ButtonMessage(0, x, y, z));
				TelaChats2ButtonMessage.handleButtonAction(entity, 0, x, y, z);
			}
