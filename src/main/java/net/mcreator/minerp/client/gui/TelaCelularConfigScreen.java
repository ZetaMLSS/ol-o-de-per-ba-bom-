...
public class TelaCelularConfigScreen extends AbstractContainerScreen<TelaCelularConfigMenu> implements MinerpModScreens.ScreenAccessor {
	...
	public void init() {
		...
		enhanced_image_button_app_config = new net.minecraft.client.gui.components.ImageButton(this.leftPos + -22, this.topPos + -69, 26, 26,
				...
				e -> {
					int x = TelaCelularConfigScreen.this.x;
					int y = TelaCelularConfigScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.minerp.network.TelaCelularConfigButtonMessage(0, x, y, z));
						net.mcreator.minerp.network.TelaCelularConfigButtonMessage.handleButtonAction(entity, 0, x, y, z);
					}
				}) {
		...
		enhanced_image_button_app_banco = new net.minecraft.client.gui.components.ImageButton(this.leftPos + 19, this.topPos + -69, 26, 26,
				...
				e -> {
					...
					int y = TelaCelularConfigScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.minerp.network.TelaCelularConfigButtonMessage(1, x, y, z));
						net.mcreator.minerp.network.TelaCelularConfigButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			private boolean guiTools$pressedToggled;
		...
		enhanced_image_button_app_policia = new net.minecraft.client.gui.components.ImageButton(this.leftPos + -22, this.topPos + -38, 26, 26, new net.minecraft.client.gui.components.WidgetSprites(
				net.minecraft.resources.ResourceLocation.parse("minerp:textures/screens/app_policia.png"), net.minecraft.resources.ResourceLocation.parse("minerp:textures/screens/app_policia.png")), e -> {
					...
					int y = TelaCelularConfigScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.minerp.network.TelaCelularConfigButtonMessage(2, x, y, z));
						net.mcreator.minerp.network.TelaCelularConfigButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			private boolean guiTools$pressedToggled;
		...
		enhanced_image_button_app_ambulancia = new net.minecraft.client.gui.components.ImageButton(this.leftPos + 19, this.topPos + -38, 26, 26, new net.minecraft.client.gui.components.WidgetSprites(
				net.minecraft.resources.ResourceLocation.parse("minerp:textures/screens/app_ambulancia.png"), net.minecraft.resources.ResourceLocation.parse("minerp:textures/screens/app_ambulancia.png")), e -> {
					...
					int y = TelaCelularConfigScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.minerp.network.TelaCelularConfigButtonMessage(3, x, y, z));
						net.mcreator.minerp.network.TelaCelularConfigButtonMessage.handleButtonAction(entity, 3, x, y, z);
					}
				}) {
			private boolean guiTools$pressedToggled;
		...
		enhanced_image_button_app_urbr = new net.minecraft.client.gui.components.ImageButton(this.leftPos + -2, this.topPos + 27, 26, 26,
				...
				e -> {
					...
					int y = TelaCelularConfigScreen.this.y;
					if (true) {
						net.neoforged.neoforge.network.PacketDistributor.sendToServer(new net.mcreator.minerp.network.TelaCelularConfigButtonMessage(6, x, y, z));
						net.mcreator.minerp.network.TelaCelularConfigButtonMessage.handleButtonAction(entity, 6, x, y, z);
					}
				}) {
			private boolean guiTools$pressedToggled;
