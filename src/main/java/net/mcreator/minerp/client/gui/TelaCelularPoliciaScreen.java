...
public class TelaCelularPoliciaScreen extends AbstractContainerScreen<TelaCelularPoliciaMenu> implements MinerpModScreens.ScreenAccessor {
	...
	public TelaCelularPoliciaScreen(TelaCelularPoliciaMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("minerp:textures/screens/tela_celular_policia.png");
