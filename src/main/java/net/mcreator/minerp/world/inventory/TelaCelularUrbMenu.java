...
@EventBusSubscriber
public class TelaCelularUrbMenu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaCelularUrbMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CELULAR_URB.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaCelularUrbMenu menu) {
