...
@EventBusSubscriber
public class TelaChats9Menu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaChats9Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CHATS_9.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaChats9Menu menu) {
