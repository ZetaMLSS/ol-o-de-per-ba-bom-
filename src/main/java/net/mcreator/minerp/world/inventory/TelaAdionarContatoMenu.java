...
@EventBusSubscriber
public class TelaAdionarContatoMenu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaAdionarContatoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_ADIONAR_CONTATO.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaAdionarContatoMenu menu) {
