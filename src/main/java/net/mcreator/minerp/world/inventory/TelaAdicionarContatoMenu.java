...
@EventBusSubscriber
public class TelaAdicionarContatoMenu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaAdicionarContatoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_ADICIONAR_CONTATO.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaAdicionarContatoMenu menu) {
