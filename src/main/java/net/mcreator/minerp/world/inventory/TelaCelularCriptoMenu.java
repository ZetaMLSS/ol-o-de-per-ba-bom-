...
@EventBusSubscriber
public class TelaCelularCriptoMenu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaCelularCriptoMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CELULAR_CRIPTO.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaCelularCriptoMenu menu) {
