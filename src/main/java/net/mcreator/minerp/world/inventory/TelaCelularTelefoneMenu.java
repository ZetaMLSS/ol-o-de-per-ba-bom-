...
@EventBusSubscriber
public class TelaCelularTelefoneMenu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaCelularTelefoneMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CELULAR_TELEFONE.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaCelularTelefoneMenu menu) {
