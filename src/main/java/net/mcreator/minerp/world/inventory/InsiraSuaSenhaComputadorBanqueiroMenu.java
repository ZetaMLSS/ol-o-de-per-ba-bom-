...
public class InsiraSuaSenhaComputadorBanqueiroMenu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public InsiraSuaSenhaComputadorBanqueiroMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.INSIRA_SUA_SENHA_COMPUTADOR_BANQUEIRO.get(), id);
