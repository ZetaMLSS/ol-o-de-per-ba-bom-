...
@EventBusSubscriber
public class TelaCelularCriptoPortifolioMenu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaCelularCriptoPortifolioMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CELULAR_CRIPTO_PORTIFOLIO.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaCelularCriptoPortifolioMenu menu) {
