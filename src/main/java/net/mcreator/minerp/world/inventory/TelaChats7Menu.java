...
@EventBusSubscriber
public class TelaChats7Menu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaChats7Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CHATS_7.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaChats7Menu menu) {
