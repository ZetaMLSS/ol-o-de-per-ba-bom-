...
@EventBusSubscriber
public class TelaChats6Menu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaChats6Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CHATS_6.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaChats6Menu menu) {
