...
@EventBusSubscriber
public class TelaChats8Menu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaChats8Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CHATS_8.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaChats8Menu menu) {
