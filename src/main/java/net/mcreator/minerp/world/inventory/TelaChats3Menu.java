...
@EventBusSubscriber
public class TelaChats3Menu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaChats3Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CHATS_3.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaChats3Menu menu) {
