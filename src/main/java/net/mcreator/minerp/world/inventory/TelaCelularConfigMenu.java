...
@EventBusSubscriber
public class TelaCelularConfigMenu extends AbstractContainerMenu implements MinerpModMenus.MenuAccessor {
	...
	public TelaCelularConfigMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MinerpModMenus.TELA_CELULAR_CONFIG.get(), id);
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		...
		if (entity.containerMenu instanceof TelaCelularConfigMenu menu) {
...
>>>>>>> branch 'main' of https://github.com/ZetaMLSS/ol-o-de-per-ba-bom-.git
}